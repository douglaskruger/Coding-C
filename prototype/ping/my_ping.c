/* =============================================================================
   ...
   =============================================================================
*/
static const char module_id[] __attribute__((used)) = "$Id: my_ping.c$";

/* This program was modified from some source from 
...
char* 
reverse_dns_lookup(char *ip_addr) 
{ 
...
// make a ping request 
void 
send_ping(int ping_sockfd, struct sockaddr_in *ping_addr, char *ping_dom, 
...
{ 
    ...
    { 
        ...
        fprintf(stderr, "Try: sudo chown root:root my_ping;\n sudo chmod +s my_ping\n");
        return 0; 
    } 
