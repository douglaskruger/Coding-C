/* =============================================================================
   ...
   =============================================================================
*/
static const char module_id[] __attribute__((used)) = "$Id: socket_2_stats.c$";
...
connxnstats_t* 
stats_initialize(int updateInterval) 
{
	...
	if (updateInterval < 1)
		updateInterval = DEFAULT_STATS_INTERVAL;
...
void 
stats_reportBytesSent(connxnstats_t* stats, unsigned int bytesSent) 
{
...
void 
stats_reportBytesRecd(connxnstats_t* stats, unsigned int bytesRecd) 
{
...
void 
stats_finalize(connxnstats_t* stats) 
{
...
void 
stats_refresh(connxnstats_t* stats) 
{
	while (1) 
	{
...
void 
stats_readifyNum(int num, char* readableNumStr) 
{
	if (num < 1000) 
	{
